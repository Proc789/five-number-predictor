...
<body style='max-width: 400px; margin: auto; padding-top: 40px; font-family: sans-serif; text-align: center;'>
  ...
  <div style='margin-top: 10px;'>
    <strong>目前第 {{ stage }} 關</strong>
    {% if training %}（訓練中）{% endif %}
  </div>
...
def index():
    global hot_hits, dynamic_hits, extra_hits, all_hits, total_tests, current_stage, training_stage, training
    prediction = None
        ...
        try:
            ...
            if len(history) >= 5 or training:
                ...
                if training:
                    ...
                    training_stage = 1  # reset if not in training
...
@app.route('/toggle')
def toggle():
    global training, training_stage, total_tests, all_hits, hot_hits, dynamic_hits, extra_hits
